...
(set-face-attribute 'org-level-7 nil :inherit 'org-level-8 :height 1.02)
(set-face-attribute 'org-level-6 nil :inherit 'org-level-8 :height 1.04)
(set-face-attribute 'org-level-5 nil :inherit 'org-level-8 :height 1.06)
(set-face-attribute 'org-level-4 nil :inherit 'org-level-8 :height 1.08)
(set-face-attribute 'org-level-3 nil :inherit 'org-level-8 :height 1.1) (set-face-attribute 'org-level-2 nil :inherit 'org-level-8 :height 1.15)
...
#+RESULTS:
: ((TODO . 42) (NEXT . 10002) (HOLD . 10032) (WAITING . 9749) (CANCELLED . 10008) (DONE . 10004))
...
#+RESULTS:
: ${tags:10} ${title:100} ${backlinkscount:6}
